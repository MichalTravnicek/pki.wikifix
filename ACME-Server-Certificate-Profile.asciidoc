...
The CA provides an ACME server certificate profile located at link:https://github.com/dogtagpki/pki/blob/master/base/ca/shared/profiles/ca/acmeServerCert.cfg[/usr/share/pki/ca/profiles/ca/acmeServerCert.cfg].
...
= Basic Constraints Extension Constraint and Default =
...
= User Supplied Extension in CSR Default =
