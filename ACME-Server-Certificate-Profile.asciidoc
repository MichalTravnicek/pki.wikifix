...
The ACME server certificate profile is located at link:https://github.com/dogtagpki/pki/blob/master/base/ca/shared/profiles/ca/acmeServerCert.cfg[/usr/share/pki/ca/profiles/ca/acmeServerCert.cfg].
