...
To install banner, create `/etc/pki/pki-tomcat/banner.txt` containing a banner message, for example:
...
* Tomcat default webapp config: `/etc/pki/pki-tomcat/web.xml`
...
* link:https://www.dogtagpki.org/wiki/PKI_Console[PKI Console]
* link:https://github.com/dogtagpki/pki/wiki/PKI-CLI[PKI CLI]
* link:https://www.dogtagpki.org/wiki/PKI_10.4_Access_Banner_Design[PKI 10.4 Access Banner Design]
