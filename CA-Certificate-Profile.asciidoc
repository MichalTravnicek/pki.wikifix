...
The CA provides a profile for issuing a CA certificate. The profile is located at link:https://github.com/dogtagpki/pki/blob/master/base/ca/shared/profiles/ca/caCACert.cfg[/usr/share/pki/ca/profiles/ca/caCACert.cfg].
