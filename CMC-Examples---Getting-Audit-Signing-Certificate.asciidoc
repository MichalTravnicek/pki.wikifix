= Getting Audit Signing Certificate =
...
** see `CMCRequest` cfg file example: link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/cmc.sys_auditSigning_pkcs10.cfg[cmc.sys_auditSigning_pkcs10.cfg]
...
** example: link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/HttpClient_sys_auditSigning.cfg[HttpClient_sys_auditSigning.cfg]
