...
** see `CMCRequest` cfg file example: link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/cmc.sys_subsystem_pkcs10.cfg[cmc.sys_subsystem_pkcs10.cfg]
...
** example: link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/HttpClient_sys_subsystem.cfg[HttpClient_sys_subsystem.cfg]
