...
* setup procedure: link:PKI-10.5-CMC-Shared-Token#adding-sharedtoken-authentication-plugin[CMC Shared Token - Adding SharedToken Authentication Plugin]
...
link:PKI-10.5-CMC-Shared-Token#example-revocation-procedure[CMC Shared Token - Example Revocation Procedure]
