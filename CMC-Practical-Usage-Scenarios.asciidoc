...
* setup procedure: link:PKI-10.5-CMC-Shared-Token#Adding_SharedToken_Authentication_Plugin[CMC Shared Token - Adding SharedToken Authentication Plugin]
* example: link:PKI-10.5-CMC-Shared-Token#Examples[CMC Shared Token - Examples]
...
link:PKI-10.5-CMC-Shared-Token#Example_Revocation_Procedure[CMC Shared Token - Example Revocation Procedure]
