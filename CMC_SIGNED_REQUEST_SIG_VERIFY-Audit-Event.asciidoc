...
Prepare a root CA, update the filter to log all `CMC_SIGNED_REQUEST_SIG_VERIFY` events, then link:https://github.com/dogtagpki/pki/blob/master/docs/installation/ca/Installing_CA_with_External_CA_Signing_Certificate.md[install a subordinate CA with external CA signing certificate].
