...
* link:https://github.com/dogtagpki/pki/wiki/Configuring-System-Certificate-Profiles[System Certificate Profiles] - used to generate system certificates during installation
* link:https://github.com/dogtagpki/pki/wiki/CA-Certificate-Profiles[CA Certificate Profiles] - provided by CA for use by end-entities post installation
