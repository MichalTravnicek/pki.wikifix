...
See link:Configuring-ACME-with-OpenLDAP-Database[Configuring ACME with OpenLDAP Database].

= Configuring ACME with PostgreSQL Database =

The ACME responder can be configured with a PostgreSQL database.
See link:https://github.com/dogtagpki/pki/blob/master/docs/installation/acme/Configuring-ACME-with-PostgreSQL-Database.adoc[Configuring ACME with PostgreSQL Database].
