...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/ds/schema.ldif[/usr/share/pki/acme/database/ds/schema.ldif] with the following command:
...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/ds/index.ldif[/usr/share/pki/acme/database/ds/index.ldif] with the following command:
...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/ds/indextask.ldif[/usr/share/pki/acme/database/ds/indextask.ldif] with the following command:
...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/ds/create.ldif[/usr/share/pki/acme/database/ds/create.ldif] with the following command:
...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/ds/database.conf[/usr/share/pki/acme/database/ds/database.conf].
