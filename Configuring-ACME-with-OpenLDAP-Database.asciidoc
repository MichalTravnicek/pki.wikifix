...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/openldap/schema.ldif[/usr/share/pki/acme/database/openldap/schema.ldif] with the following command:
...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/openldap/create.ldif[/usr/share/pki/acme/database/openldap/create.ldif].
...
link:https://github.com/dogtagpki/pki/blob/master/base/acme/database/openldap/database.conf[/usr/share/pki/acme/database/openldap/database.conf].
