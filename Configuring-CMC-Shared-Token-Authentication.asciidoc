...
Define the LDAP attribute to store the shared token in an LDIF file (e.g. link:https://github.com/dogtagpki/pki/blob/master/base/ca/auth/ds/schema.ldif[/usr/share/pki/ca/auth/ds/schema.ldif]).
...
Define the LDAP subtree (e.g. `ou=people,dc=example,dc=com`) to store LDAP users in an LDIF file (e.g. link:https://github.com/dogtagpki/pki/blob/master/base/ca/auth/ds/create.ldif[/usr/share/pki/ca/auth/ds/create.ldif]).
...
Define the LDAP users in an LDIF file (e.g. link:https://github.com/dogtagpki/pki/blob/master/base/ca/auth/ds/example.ldif[/usr/share/pki/ca/auth/ds/example.ldif]):
