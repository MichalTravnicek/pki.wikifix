...
The link:Continuous-Delivery[Continuous Delivery] system can be configured to publish the builds to GitHub Container Registry or other container registry (e.g. Quay.io). This can be done by creating the following GitHub variables and secrets:
