...
$ pki-server ocsp-group-member-add "Online Certificate Status Manager Agents" ocspagent
----

= Creating CRL Issuing Point in OCSP =

Export the signing certificate from the CA:
...
----
$ pki-server ocsp-issuingpoint-add --cert-chain ca_signing.crt
----
