...
Configure the LDAP server to allow anonymous access with the following command:
...
By default the CRL cache will refresh every 24 hours. To simplify testing, the refresh can be configured to happen more frequently, for example every `60` seconds:
