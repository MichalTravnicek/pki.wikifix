...
Each project has a GitHub job that will automatically publish Maven artifacts to the link:https://github.com/dogtagpki/repo/tree/maven[Maven repository] and container images to link:https://quay.io/organization/dogtagpki[Quay.io].
...
* `REGISTRY_NAMESPACE`: Quay.io namespace (default: GitHub username)
