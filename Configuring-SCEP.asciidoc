...
* link:https://github.com/dogtagpki/pki/issues/2159[Ticket #2159 - Simplify Procedure for doing SCEP on Dogtag]
* link:https://github.com/dogtagpki/pki/issues/1015[Ticket #1015 - Utilize database rather than plaintext flat files when utilizing SCEP one-time PIN]
