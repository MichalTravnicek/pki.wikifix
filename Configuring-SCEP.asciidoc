...
* link:https://fedorahosted.org/pki/ticket/1600[Ticket #1600 - Simplify Procedure for doing SCEP on Dogtag]
* link:https://fedorahosted.org/pki/ticket/444[Ticket #444 - Utilize database rather than plaintext flat files when utilizing SCEP one-time PIN]
