...
System certificate profiles are used to generate the initial system certificates during CA installation (see link:Two-Step-Installation[Two-Step Installation]). These profiles are no longer used after installation.
