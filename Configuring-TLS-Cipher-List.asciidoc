...
To configure the TLS server cipher list, edit the cipher list in `/var/lib/pki/pki-tomcat/conf/server.xml` as needed (see link:https://github.com/dogtagpki/tomcatjss/wiki/Configuring-Tomcat-JSS[Configuring Tomcat JSS]):
