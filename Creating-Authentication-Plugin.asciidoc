...
* Download link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/pki_authentication.tar.gz[pki_authentication.tar.gz].
...
** link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/SSNAuth.java[SSNAuth.java] - the source code for this authentication plugin,
** link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/SSNEnroll.cfg[SSNEnroll.cfg] - the configuration file for this authentication plugin, and 
** link:https://raw.githubusercontent.com/wiki/dogtagpki/pki/files/build.sh[build.sh] - the build script used to create this authentication plugin.
...
* Launch a browser.
* Type the URL `https://<hostname>:<port>/<pki-subsystem>/ee/<pki-subsystem>`, where `<pki-subsystem>` is always `ca` for authentication plugins, into the browser to list the CA Certificate Profiles:
