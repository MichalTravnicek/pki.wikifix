...
** `ca_ocsp_signing` certificate and key (see link:Generating-OCSP-Signing-Certificate[Generating OCSP Signing Certificate])
** `ca_audit_signing` certificate and key (see link:Generating-Audit-Signing-Certificate[Generating Audit Signing Certificate])
...
* `ca_audit_signing.csr` certificate request
