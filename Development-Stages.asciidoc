...
Maintenance is the stage where the code is updated to fix issues found after GA. The update should contain bug fixes only. New features should be added in the next version.
