...
* link:https://www.dogtagpki.org/wiki/Enabling_SSL_Connection_with_Internal_Database[SSL connection is already enabled]
...
Remove the unused parameters internaldb.ldapauth.bindDN and internaldb.ldapauth.bindPWPrompt.
