...
*Note:* Newer DS versions have the certificates created and SSL connection enabled by default,
so it's not necessary to follow the process described in this page.
