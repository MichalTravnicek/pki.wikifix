= Generating CA Signing CSR with New Key =
...
= Generating CA Signing Key =

----
$ openssl genrsa -out ca_signing.key 2048
----

= Generating CA Signing CSR with Existing Key =
...
* link:https://www.dogtagpki.org/wiki/Issuing_CA_Signing_Certificate_with_OpenSSL[Issuing CA Signing Certificate with OpenSSL]
* link:https://github.com/dogtagpki/pki/wiki/Creating-Self-Signed-CA-Signing-Certificate-with-OpenSSL[Creating Self-Signed CA Signing Certificate with OpenSSL]
