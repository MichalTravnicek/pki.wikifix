...
Note that the link:PKI-Client-CLI[PKI Client CLI] provides a simplified mechanism to generate and submit a CSR for client certificates. See link:https://www.dogtagpki.org/wiki/Certificate_Profiles[Certificate Profiles].
...
To generate and submit the request using CRMFPopClient, see link:https://www.dogtagpki.org/wiki/Certificate_Key_Archival[Certificate Key Archival].

= See Also =

* link:https://www.dogtagpki.org/wiki/Certificate_Management[Certificate Management]
* link:https://www.dogtagpki.org/wiki/Submitting_Certificate_Request[Submitting Certificate Request]
