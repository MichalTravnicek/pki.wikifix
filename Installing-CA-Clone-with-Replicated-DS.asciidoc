...
* Replication has been link:https://github.com/dogtagpki/389-ds-base/wiki/Configuring-DS-Replication[configured] between the primary DS and the secondary DS.
