...
* A shared DS has been link:https://github.com/dogtagpki/pki/wiki/Installing-DS-Server[installed].
* A primary CA has been link:https://github.com/dogtagpki/pki/blob/master/docs/installation/ca/installing-ca.adoc[installed] using the shared DS.
