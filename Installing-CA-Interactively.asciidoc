...
Additionally, make sure the FQDN has been link:https://github.com/dogtagpki/pki/blob/master/docs/installation/server/FQDN_Configuration.adoc[configured] correctly.
