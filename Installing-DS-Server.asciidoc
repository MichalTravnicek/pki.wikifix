Note: This page has been moved/converted to the following two pages:

* link:https://github.com/dogtagpki/pki/blob/master/docs/installation/others/Installing_DS_Packages.adoc[Installing DS Packages]
* link:https://github.com/dogtagpki/pki/blob/master/docs/installation/others/Creating_DS_instance.adoc[Directory Server Instance Creation]
