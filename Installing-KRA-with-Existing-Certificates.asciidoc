...
To export the keys, CSRs, and certificates from an existing KRA instance, see link:Exporting-KRA-System-Certificates[Exporting KRA System Certificates].

For testing, new KRA keys, CSRs, and certificates can be created as follows:
