...
To migrate the existing KRA subsystem to a new machine, the existing subsystem and the SSL server certificates should not be added into the PKCS #12 file, or should be removed from the PKCS #12 file with the following commands:
