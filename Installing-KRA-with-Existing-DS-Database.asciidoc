...
The `kra_storage.csr` can be found in `/etc/pki/pki-tomcat/certs`.
...
The `kra_transport.csr` can be found in `/etc/pki/pki-tomcat/certs`.
...
The `kra_audit_signing.csr` can be found in `/etc/pki/pki-tomcat/certs`.
...
The `subsystem.csr` can be found in `/etc/pki/pki-tomcat/certs`.
...
The `sslserver.csr` can be found in `/etc/pki/pki-tomcat/certs`.
