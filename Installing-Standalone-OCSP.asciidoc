...
See also link:https://github.com/dogtagpki/pki/blob/master/docs/installation/ocsp/installing-ocsp-with-external-certificates.adoc[Installing OCSP with External Certificates].
