...
In this scenario, the OCSP uses an external CA to issue the OCSP system certificates. It does not join the CA's security domain, and CRL publishing will need to be link:Configuring-OCSP-Publishing[configured] separately in the CA.
