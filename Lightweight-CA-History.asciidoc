...
Should the security of the `CryptoManager` implementation (above) prove insufficient, a link:https://www.opendnssec.org/softhsm[SoftHSM] implementation will be investigated in depth.
