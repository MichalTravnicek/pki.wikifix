...
* Enter a title for the new page. It doesn't have to be exactly the same as the old page. Simplify the title if possible.
* Copy and paste the old page into the new page. Change the *Edit mode* to *MediaWiki*.
* Optionally, convert the content into AsciiDoc, and change the *Edit mode* to *AsciiDoc*.
* Click *Preview* to verify that the content is correctly displayed. Compare with the old page.
* Click *Save Page*.

== Linking the New Page ==

* Find an existing page in the new wiki to add a link to the new page.
