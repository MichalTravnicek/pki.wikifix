...
For host CA in CA subsystem, the log will look like the following:
...
For lightweight sub-CA in CA subsystem, the log will include the authority ID:
...
For OCSP subsystem, the log will look like the following:
