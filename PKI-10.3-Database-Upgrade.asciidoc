...
See also link:PKI-Server-KRA-CLI[PKI Server KRA CLI].
...
See also link:PKI-Server-TPS-CLI[PKI Server TPS CLI].
...
----
$ git diff DOGTAG_10_3_BRANCH:base/server/share/conf/database.ldif master:base/server/share/conf/database.ldif
$ git diff DOGTAG_10_3_BRANCH:base/server/share/conf/manager.ldif master:base/server/share/conf/manager.ldif
----
...
----
$ git diff DOGTAG_10_3_BRANCH:base/server/share/conf/schema.ldif master:base/server/share/conf/schema.ldif
----
...
----
$ git diff DOGTAG_10_3_BRANCH:base/ca/shared/conf/db.ldif master:base/ca/shared/conf/db.ldif
$ git diff DOGTAG_10_3_BRANCH:base/ca/shared/conf/acl.ldif master:base/ca/shared/conf/acl.ldif
$ git diff DOGTAG_10_3_BRANCH:base/ca/shared/conf/index.ldif master:base/ca/shared/conf/index.ldif
----
...
----
$ git diff DOGTAG_10_3_BRANCH:base/kra/shared/conf/db.ldif master:base/kra/shared/conf/db.ldif
$ git diff DOGTAG_10_3_BRANCH:base/kra/shared/conf/acl.ldif master:base/kra/shared/conf/acl.ldif
$ git diff DOGTAG_10_3_BRANCH:base/kra/shared/conf/index.ldif master:base/kra/shared/conf/index.ldif
----
...
----
$ git diff DOGTAG_10_3_BRANCH:base/ocsp/shared/conf/db.ldif master:base/ocsp/shared/conf/db.ldif
$ git diff DOGTAG_10_3_BRANCH:base/ocsp/shared/conf/acl.ldif master:base/ocsp/shared/conf/acl.ldif
$ git diff DOGTAG_10_3_BRANCH:base/ocsp/shared/conf/index.ldif master:base/ocsp/shared/conf/index.ldif
----
...
----
$ git diff DOGTAG_10_3_BRANCH:base/tks/shared/conf/db.ldif master:base/tks/shared/conf/db.ldif
$ git diff DOGTAG_10_3_BRANCH:base/tks/shared/conf/acl.ldif master:base/tks/shared/conf/acl.ldif
$ git diff DOGTAG_10_3_BRANCH:base/tks/shared/conf/index.ldif master:base/tks/shared/conf/index.ldif
----
...
----
$ git diff DOGTAG_10_3_BRANCH:base/tps/shared/conf/db.ldif master:base/tps/shared/conf/db.ldif
$ git diff DOGTAG_10_3_BRANCH:base/tps/shared/conf/acl.ldif master:base/tps/shared/conf/acl.ldif
$ git diff DOGTAG_10_3_BRANCH:base/tps/shared/conf/index.ldif master:base/tps/shared/conf/index.ldif
----
