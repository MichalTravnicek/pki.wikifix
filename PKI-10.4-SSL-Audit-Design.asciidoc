...
This is documented in link:https://www.dogtagpki.org/wiki/NSS_SSL_Alert_Callback[NSS SSL Alert Callback].
...
This is documented in link:Configuring-Signed-Audit-Logging[Configuring Signed Audit-Logging].
