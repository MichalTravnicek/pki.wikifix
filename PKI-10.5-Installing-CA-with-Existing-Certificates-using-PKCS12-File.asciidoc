...
The CA installation with existing certificates using PKCS #12 file is part of link:https://www.dogtagpki.org/wiki/Migrating_a_CA_using_existing_CA_mechanism[CA migration procedure without HSM]. In this process the existing certificates and keys will be migrated using a PKCS #12 file.
...
-----------------
  ...
  Full name: CA-server.example-8443
