...
For SoftHSM, setup the SoftHSM by following link:https://www.dogtagpki.org/wiki/SoftHSM[this guide] and then add the following parameters:
...
----
$ certutil -K -d /etc/pki/pki-tomcat/alias -f password.txt
