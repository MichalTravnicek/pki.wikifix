...
https://www.dogtagpki.org/wiki/PKI_Roles_and_Privileges
...
link:https://www.dogtagpki.org/wiki/Enabling_SSL_Connection_with_Internal_Database_on_New_Instance#Generating_Temporary_DS_Certificate[Enabling SSL Connection with Internal Database on New Instance#Generating_Temporary_DS_Certificate]

And here you will find instruction on "Enabling Secure Connection in DS":
link:https://www.dogtagpki.org/wiki/Enabling_SSL_Connection_with_Internal_Database_on_New_Instance#Enabling_Secure_Connection_in_DS[Enabling SSL Connection with Internal Database on New Instance#Enabling_Secure_Connection_in_DS]
...
* Enable signed audit:
** follow: link:https://www.dogtagpki.org/wiki/Signed_Audit_Log#Configuration[Signed Audit Log#Configuration]
