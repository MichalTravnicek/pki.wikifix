...
This page shows my developer's example test scenarios that I have used for testing the following ticket:
https://pagure.io/dogtagpki/issue/2772 TPS incorrectly assigns "tokenOrigin" and "tokenType" certificate attribute for recovered certificates.
