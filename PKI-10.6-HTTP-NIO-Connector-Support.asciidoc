...
<Connector name="Secure"
       ...
       ...
       keystoreType="pkcs12"
       keystoreFile="/etc/pki/pki-tomcat/keystore.p12"
       keystorePassFile="/etc/pki/pki-tomcat/keystore.pwd"
       keyAlias="sslserver"
...
The upgrade procedure is documented in link:https://www.dogtagpki.org/wiki/Upgrading_PKI_10.5_to_PKI_10.6[this page].

= HSM Support =

== Providing PKCS #11 Key Store ==

JSS may be able to provide a PKCS #11 keystore for the NIO connector. See also link:https://www.dogtagpki.org/wiki/JSS_KeyStore[JSS KeyStore].
...
* link:https://www.dogtagpki.org/wiki/PKI_10.6_Tomcat_8.5_Support[PKI 10.6 Tomcat 8.5 Support]
