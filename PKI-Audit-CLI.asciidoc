...
To access the log files prepare a system user account with a link:https://www.dogtagpki.org/wiki/User_Certificate[User Certificate].

To add the user into the Auditors group:

----
$ pki -n caadmin ca-group-member-add Auditors <user>
----

The user will be able to access the audit logs with the user certificate:
