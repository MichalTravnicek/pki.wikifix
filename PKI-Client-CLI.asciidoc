...
See also [https://www.dogtagpki.org/wiki/Certificate_Key_Archival#Submitting_Certificate_Request submitting certificate request with key archival].
...
<pre>
$ pki ... user-find
WARNING: UNTRUSTED ISSUER encountered on 'CN=server.example.com,O=EXAMPLE' indicates a non-trusted CA cert 'CN=CA Signing Certificate,O=EXAMPLE'
...
* [https://github.com/dogtagpki/pki/wiki/Generating-Certificate-Request Generating Certificate Request]
* [https://www.dogtagpki.org/wiki/Certificate_Profiles Certificate Profiles]
