...
PKI provides REST interface to allow clients to access services on the server. The REST services are implemented using link:https://www.dogtagpki.org/wiki/RESTEasy[RESTEasy].
...
* link:https://www.dogtagpki.org/wiki/REST_API_Design[REST API Design]
