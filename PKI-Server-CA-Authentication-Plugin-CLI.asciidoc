...
Store templates in to the file and use them to add auth plugin instance
(scope future)
...
* link:https://www.dogtagpki.org/wiki/CA_Authentication_Plugins[CA Authentication Plugins]
