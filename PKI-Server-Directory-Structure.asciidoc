...
* `pki-tomcatd`: This directory structure is used to run PKI server on Fedora which follows the link:http://www.pathname.com/fhs/[Filesystem Hierarchy Standard].
