...
$ pki-server status
  ...
  CA Subsystem:
    ...
    PKI Console URL:     https://localhost:8443/ca
  ...
  KRA Subsystem:
    ...
    PKI Console URL:     https://localhost:8443/kra
  ...
  OCSP Subsystem:
    ...
    PKI Console URL:     https://localhost:8443/ocsp
  ...
  TKS Subsystem:
    ...
    PKI Console URL:     https://localhost:8443/tks
