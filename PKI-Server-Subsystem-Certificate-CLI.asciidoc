...
The pki-server provides commands to manage system certificates. See also link:https://github.com/dogtagpki/pki/blob/master/base/server/python/pki/server/cli/subsystem.py[subsystem.py].
