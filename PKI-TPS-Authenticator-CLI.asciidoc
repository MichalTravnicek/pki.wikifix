...
---------------------
  ...
  Properties:
    ...
    auths.instance.ldap1.ldap.ldapconn.host: server.example.com
...
<Authenticator id="ldap1" xmlns:ns2="http://www.w3.org/2005/Atom">
    <Link href="https://server.example.com:8443/tps/rest/authenticators/ldap1" rel="self"/>
    <Properties>
        ...
        <Property name="auths.instance.ldap1.ldap.ldapconn.host">server.example.com</Property>
