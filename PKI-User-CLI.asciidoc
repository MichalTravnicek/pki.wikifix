...
Each PKI subsystem (i.e. CA, KRA, OCSP, TKS, TKS) provides a CLI to manage the system users. All commands must be executed as an administrator of the corresponding subsystem. However, link:Default-CA-Admin[the default the CA admin certificate] can be used to authenticate as the administrator of each subsystem.
