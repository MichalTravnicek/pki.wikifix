...
* link:https://www.dogtagpki.org/wiki/Enabling_Client_Certificate_Authentication_with_Internal_Database[Enabling Client Certificate Authentication with Internal Database]
