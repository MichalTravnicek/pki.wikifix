Since version 10.5 a `RANDOM_GENERATION` audit event will be generated for any random number generated on the server (including link:Random-Certificate-Serial-Numbers[Random Certificate Serial Numbers]).
