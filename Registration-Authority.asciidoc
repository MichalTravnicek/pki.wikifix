...
The RA subsystem is implemented as a set of Perl scripts and it runs on top of Apache. An link:http://www.sqlite.org[SQLite] database is used for data storage.

NOTE: This feature has no longer been supported since PKI 9.