...
To transfer PKI server files to the new machine, use the link:Backing-Up-PKI-Server[backup] and link:Restoring-PKI-Server[restore] procedure, but do not restart the server yet.
