...
Also update the following lines in /var/lib/pki/pki-tomcat/conf/ca/CS.cfg with the Base64-encoded data of the new certificates (without header & footer):
...
* link:https://www.dogtagpki.org/wiki/Certificate_Renewal[Certificate Renewal]
