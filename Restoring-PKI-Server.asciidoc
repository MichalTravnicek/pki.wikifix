...
* The server should be restored on a machine with the same hostname since the hostname of the original machine might be stored in various files, certificates, and database entries.
