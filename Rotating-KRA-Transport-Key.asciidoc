...
KRA transport key and certificate generation is part link:https://www.dogtagpki.org/wiki/DRM_Transport_Key_Rotation[KRA Transport Key Rotation] process.
