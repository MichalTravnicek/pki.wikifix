...
WARNING: The migration process must be done in parallel for all CA instances. Complete each migration step for all CA instances before moving on to the next step.
