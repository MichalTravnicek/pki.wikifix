...
This page describes audit events that are common in all PKI subsystems. The complete list of events, the message format, and the event description are stored in link:https://github.com/edewata/pki/blob/dev/base/server/cmsbundle/src/audit-events.properties[audit-events.properties].
