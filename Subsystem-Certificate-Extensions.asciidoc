...
* link:https://github.com/dogtagpki/pki/blob/master/base/ca/shared/conf/rsaSubsystemCert.profile[rsaSubsystemCert.profile]
* link:https://github.com/dogtagpki/pki/blob/master/base/ca/shared/conf/eccSubsystemCert.profile[eccSubsystemCert.profile]
