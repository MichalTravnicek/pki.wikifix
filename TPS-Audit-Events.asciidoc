...
See link:TOKEN_FORMAT_FAILURE-Audit-Event[TOKEN_FORMAT_FAILURE].

== TOKEN_APPLET_UPGRADE_SUCCESS ==

See link:TOKEN_APPLET_UPGRADE_SUCCESS-Audit-Event[TOKEN_APPLET_UPGRADE_SUCCESS].

== TOKEN_APPLET_UPGRADE_FAILURE ==

See link:TOKEN_APPLET_UPGRADE_FAILURE-Audit-Event[TOKEN_APPLET_UPGRADE_FAILURE].

== TOKEN_STATE_CHANGE ==

See link:TOKEN_STATE_CHANGE-Audit-Event[TOKEN_STATE_CHANGE].
