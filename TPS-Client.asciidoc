...
----
$ ldapadd -H ldap://localhost -D "cn=Directory Manager" -w Secret.123 << EOF
...
----
$ ldapsearch -H ldap://localhost -x -D "uid=testuser,ou=people,dc=example,dc=com" -w Secret.123 -b "" -s base
----
