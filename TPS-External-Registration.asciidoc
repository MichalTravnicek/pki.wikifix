...
* *Delegation Option*
** In the second part of this document, an optional enhancement called "<b>Delegation Option</b>" is introduced. The Delegation option will be useful in the scenario that a delegate could potentially own a token which contains certain certificates and their keys so that a delegate can act on behalf of the executive.
