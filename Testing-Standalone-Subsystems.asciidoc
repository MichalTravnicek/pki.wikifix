...
----
$ grep "\.certreq=" /etc/pki/standalone-kra/kra/CS.cfg
...
----
$ grep "preop.cert.admin.dn=" /etc/pki/standalone-kra/kra/CS.cfg
...
----
$ grep "\.cert=" /etc/pki/standalone-kra/kra/CS.cfg
...
----
$ ls -1 /etc/pki/standalone-kra/*.csr
kra_admin.csr
...
*** `/etc/pki/standalone-kra/kra_admin.csr`
...
*** `/etc/pki/standalone-kra/kra_audit_signing.csr`
** Manual Server Certificate Enrollment
*** `/etc/pki/standalone-kra/kra_sslserver.csr`
** Manual Subsystem Certificate Enrollment
*** `/etc/pki/standalone-kra/kra_subsystem.csr`
** Manual Data Recovery Manager Storage Certificate Enrollment
*** `/etc/pki/standalone-kra/kra_storage.csr`
** Manual Data Recovery Manager Transport Certificate Enrollment
*** `/etc/pki/standalone-kra/kra_transport.csr`
